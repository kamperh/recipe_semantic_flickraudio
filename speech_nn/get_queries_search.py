...
"""
Split a given subset into queries and search collection.s
...
def check_argv():
    ...
    parser.add_argument(
        ...
        choices=["fbank_vad", "mfcc_cmvn_dd_vad"]
        )
    parser.add_argument(
...
def main():
    ...
    # Subset features
    features_dict_fn = path.join("data", args.features, args.subset + ".npz")
